...
def main():
    ...
    # Expectation value
    exp_number_of_detected_objects = 2

    # Iterate over all time steps
    for current_time_step in range(2, trace_file.timestep_count):
    ...
    # Calculate parameter to check
    avg_number_of_detected_objects = avg_number_of_detected_objects / (trace_file.timestep_count - 2)
