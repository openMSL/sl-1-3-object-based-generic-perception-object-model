...
void get_refined_bounding_box_definition(std::vector<std::vector<float>>& bounding_box_definition, std::vector<std::vector<int>>& surfaces_definition, MovingObject::Type type)
{
    ...
    if (type == osi3::MovingObject_Type_TYPE_VEHICLE)
    {
        ...
        surfaces_definition = {{2, 1, 5, 7, 9, 10}, {1, 0, 4, 5}, {3, 0, 4, 6, 8, 11}, {3, 2, 10, 11}, {10, 9, 8, 11}, {9, 7, 6, 8}, {7, 5, 4, 6}, {2, 1, 0, 3}};
    }
    else
    {
        bounding_box_definition = {
            {0.5, 0.5, 0.5}, {0.5, 0.5, -0.5}, {0.5, -0.5, 0.5}, {0.5, -0.5, -0.5}, {-0.5, 0.5, 0.5}, {-0.5, 0.5, -0.5}, {-0.5, -0.5, 0.5}, {-0.5, -0.5, -0.5}};
        surfaces_definition = {{7, 3, 2, 6}, {3, 1, 0, 2}, {2, 1, 0, 4}, {7, 5, 4, 6}, {6, 2, 0, 4}, {7, 3, 1, 5}};
    }
}
                                 ...
                                 const Alert& alert)
{
    for (auto& current_vertex_definition : bounding_box_definition)
    {
        ...
        osi3::Vector3d current_vertex_world_coord =
