...
namespace model {
    ...
    public:
        ...
        static Vector3d transform_position_from_world_to_sensor_coordinates(const Vector3d &input_in_world_coordinates, const TF::EgoData &ego_data, const MountingPosition &mounting_pose);
        ...
        static Vector3d transform_position_from_sensor_to_object_coordinates(const Vector3d &pcl_segment_position_in_sensor, const EgoData &ego_data, const MountingPosition &mounting_pose, const BaseMoving &object_base);
        static Vector3d transform_position_from_object_to_sensor_coordinates(const Vector3d &pcl_segment_position_in_object, const TF::EgoData &ego_data, const MountingPosition &mounting_pose, const BaseMoving &object_base);
        ...
        static Orientation3d transform_orientation_from_world_to_sensor_coordinates(const Orientation3d &orientation_in_world_coordinates, const TF::EgoData &ego_data, const MountingPosition &mounting_pose);
