...
private:
    ...
    static double get_rcs_in_sm(osi3::SensorData &sensor_data, int current_object_id);
    ...
    void transform_detections_to_logical_detections(osi3::SensorData &sensor_data, const osi3::LidarDetectionData &detection_data, const TransformationFunctions::EgoData &ego_data) const;
    };
